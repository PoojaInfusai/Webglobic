...
namespace Webglobic.Models
{
    public class ObjectBuilding
    {
        ...
        [StringLength(50, MinimumLength = 5, ErrorMessage = "Location must be between 5 and 50 characters.")]
        ...
        [Required(ErrorMessage = "Address To is required.")]
        [StringLength(150, MinimumLength = 10, ErrorMessage = "Address To must be between 10 and 150 characters.")]
